...
class GaushalaAccountStatement:
    ...
    def __init__(self, master):
        ...
        self.gaushala_account_statement_window(master)

    def gaushala_account_statement_window(self, master):
        gaushala_account_statement_window = Toplevel(master)
        gaushala_account_statement_window.title("Gaushala Accounts Statement ")
        gaushala_account_statement_window.geometry('770x460+120+40')
        gaushala_account_statement_window.configure(background='wheat')
        gaushala_account_statement_window.resizable(width=False, height=False)

        # delete "X" button in window will be not-operational
        gaushala_account_statement_window.protocol('WM_DELETE_WINDOW', self.obj_commonUtil.donothing)

        imageFrame = Frame(gaushala_account_statement_window, width=65, height=60,
                           bg="wheat")
        ...
        infoFrame = Frame(gaushala_account_statement_window, width=300, height=100, bd=6, relief='ridge',
                          bg="wheat")
        topFrame = Frame(gaushala_account_statement_window, width=300, height=100, bd=6, relief='ridge',
                         bg="light yellow")
        ...
        heading = Label(gaushala_account_statement_window, text="Gaushala Account Statement",
        ...
        printBtn = Button(buttonFrame, text="Print Statement", fg="Black",
                          font=NORM_FONT, width=12, bg='light grey', state=DISABLED)
        cancel = Button(buttonFrame, text="Close", fg="Black", command=gaushala_account_statement_window.destroy,
                        font=NORM_FONT, width=12, bg='light cyan')
        search_result = partial(self.prepare_account_statement_Excel, gaushala_account_statement_window, printBtn,
                                cal_dateFrom,
        ...
        # create a Close Button and place into the gaushala_account_statement_window  window

        cancel.grid(row=0, column=3)
        # ---------------------------------Button Frame End----------------------------------------

        gaushala_account_statement_window.bind('<Return>', lambda event=None: submit.invoke())
        gaushala_account_statement_window.bind('<Alt-c>', lambda event=None: cancel.invoke())

        gaushala_account_statement_window.focus()
        gaushala_account_statement_window.grab_set()
        mainloop()
