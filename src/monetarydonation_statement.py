...
class MonetarydonationStatement:
    # constructor for Library class
    def __init__(self, master):
        print("constructor called for noncommercial edit ")
        self.obj_commonUtil = CommonUtil()
        self.dateTimeOp = DatetimeOperation()
        self.donation_monthlyseva_sheet(master)

    def donation_monthlyseva_sheet(self, master):
        transaction_summary_window = Toplevel(master)

        transaction_summary_window.title("Donation Statement ")
        transaction_summary_window.geometry('770x560+120+40')
        ...
        heading = Label(transaction_summary_window, text="Donation Statement",
        ...
        category_label = Label(category_frame, text="Select Seva Type", width=14, justify='center', font=NORM_FONT,
        ...
        buttonFrame.grid(row=2, column=0, padx=10, pady=5, columnspan=3)
        ...
        search_result = partial(self.prepare_account_statement_Excel, transaction_summary_window, printBtn,
                                cal_dateFrom,
                                cal_toDate, month_variable, year_variable,
                                year_yearvariable, var, categoryText, viewPDF, infoLabel, cancel)
    ...
    def prepare_account_statement_Excel(self, account_statement_window, printBtn, cal_dateFrom,
                                        ...
                                        viewbyYear_yearTxt, var, categoryText, viewPDF, infoLabel, cancelbtn):
            ...
            if from_year == self.obj_commonUtil.getCurrentYearFolderName() and \
                ...
                if bAlike_seva:
                    ...
                    if total_records > 0:
                        ...
                        destination_file = "..\\Expanse_Data\\" + currentyear + "\\Seva_Rashi\\Statements\\Statement_Donation" + dt_string + ".pdf"
                        # write the  sorted record in statement template
                        template_statement = "..\\Expanse_Data\\" + currentyear + "\\Seva_Rashi\\Template\\account_statement_template.xlsx"
                ...
                for year_loop in range(1, loop_range):
                    ...
                    if total_records > 0:
                        ...
                        destination_file = "..\\Expanse_Data\\" + currentyear + "\\Seva_Rashi\\Statements\\Statement_Donation" + dt_string + ".pdf"
                        # write the  sorted record in statement template
                        template_sheet = "..\\Expanse_Data\\" + currentyear + "\\Seva_Rashi\\Template\\account_statement_template.xlsx"
